...
* Bit fields :
    ...
    -   _**Sign bit**_ : - if '0' ==> Positive number <hr/>; - if '1' ==> Negative number
	    
    -   _**Regime bits**_ : - /r : '1'   -->       k = -m                         m : nb of '0' <hr/>; - /r : '0'   -->       k= m-1                         m: nb of '1'
	   
    -   _**Exponent bits**_ : e  : value of exponent 
	    
    -   _**Fraction bits**_ : fract  : _fract_ / 2^(i) <hr/>; i : size of fraction
